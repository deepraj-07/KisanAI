...
const SCHEME_I18N: Record<string, { nameHi: string; descriptionHi: string; eligibilityHi: string[] }> = {
  ...
  "fasal-bima": {
    ...
    eligibilityHi: ["सूचित फसल उगाने वाले किसान", "ऋणी किसान स्वत: कवर"],
  },
  "kcc": {
    nameHi: "किसान क्रेडिट कार्ड (केसीसी)",
    descriptionHi: "खेती, कटाई बाद खर्च और संबद्ध गतिविधियों के लिए अल्पकालिक ऋण सुविधा।",
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-bold text-[#e8f5e9]">
              {lang === "hi" ? "सरकारी सहायता पारिस्थितिकी तंत्र" : "Government Support Ecosystem"}
            </h1>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 rounded-lg border border-[#2a3d2c] p-1">
              <button
                onClick={() => setLang("en")}
                className={cn("px-2 py-1 text-xs rounded", lang === "en" ? "bg-[#2ea82e]/20 text-[#4dc24d]" : "text-[#94a896]")}
              >
                English
              </button>
              <button
                onClick={() => setLang("hi")}
                className={cn("px-2 py-1 text-xs rounded", lang === "hi" ? "bg-[#2ea82e]/20 text-[#4dc24d]" : "text-[#94a896]")}
              >
                हिंदी
              </button>
            </div>
          ...
          >
            <div className="relative z-10">
              ...
              <h2 className="text-lg font-bold text-white mt-1 leading-snug">
                {lang === "hi" ? (
                  <>
                    आप <span className="text-[#4dc24d]">12 योजनाओं</span> के लिए पात्र हैं, लगभग{" "}
                    <span className="text-[#4dc24d]">₹45,000</span> लाभ तक।
                  </>
                ) : (
                  <>
