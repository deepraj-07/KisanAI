/**
 * core/firebase/advisor-history.ts
...
import type { ChatMessage, ChatSession } from "@/app/(dashboard)/advisor/types";
import type { ChatMode } from "@/core/data/firestore-schema";
