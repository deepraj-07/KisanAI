    ...
    <div className="flex flex-col items-center">
      ...
      <div className="relative" style={{ width: size, height: size }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-widest text-[#B8A99A] mt-0.5">
            Optimization
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6 mt-4">
        {[
          { label: "Yield",       value: "+12%",      color: "text-[#F5F0E8]" },
          { label: "Soil Health", value: "Excellent",  color: "text-white" },
          { label: "Irrigation",  value: "92% Eff.",   color: "text-blue-400"  },
        ].map(({ label, value, color }) => (
          <div key={label} className="text-center">
            <p className="text-[10px] uppercase tracking-widest text-[#B8A99A] mb-0.5">{label}</p>
